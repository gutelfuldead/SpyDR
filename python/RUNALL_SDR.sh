...
$LOC/tx_2_read_data.py & > /dev/null

echo "running tx_3_FEC"
$LOC/tx_3_FEC.py & > /dev/null

echo "running tx_4_qpsk_mod"
$LOC/tx_4_qpsk_mod.py & > /dev/null

echo "running awgn_burst_errors_CHANNEL"
$LOC/awgn_burst_errors_CHANNEL.py & > /dev/null

echo "running rx_1_qpsk_demod"
$LOC/rx_1_qpsk_demod.py & > /dev/null

echo "running rx_2_decode"
$LOC/rx_2_decode.py & > /dev/null

echo "running rx_3_reconstruct"
$LOC/rx_3_reconstruct.py &
